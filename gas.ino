...
const char* ssid = "Your SSID";        //SSID of Wifi network
const char* password = "Your Password";   // Password of wifi network
#define emailSenderAccount    "Your Sender E-mail"    // Sender email address
#define emailSenderPassword   "Your Password"            // Sender email password
#define smtpServer            "smtp.gmail.com"
#define smtpServerPort        465
#define emailSubject          "ALERT! Gas Leak Detected"   // Email subject
String inputMessage = "Your receipent E-mail";   //Reciepent email alert.
String enableEmailChecked = "checked";
String inputMessage2 = "true";
 // Default Threshold Value
String inputMessage3 = "10.0";                    // Default gas_value
String lastgaslevel;
